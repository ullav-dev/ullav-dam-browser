...
function TreeNodeItem({
  ...
  return (
    <div>
      <div
        className={`flex items-center gap-1 py-1.5 rounded-md cursor-pointer text-sm transition-colors ${
          isSelected
...
export default function CategoryTree({ categories, selectedId, onSelect, assetCounts }: Props) {
